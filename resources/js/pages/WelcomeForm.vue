...
const cityValidator = computed(()=>{
    return form.value.city === "Otro"
})
...
const validation = computed(()=>{
    if(form.value.city != "Otro"){
        
        return form.value.city !== ""
    }

    if(cityValidator.value){
        return form.value.customCity && form.value.customCity.length > 0
    }
    return false
})
            ...
            >
                ...
                <div v-if="currentStep === 3" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                       ...
                       <div  v-if="cityValidator" class="flex flex-col gap-2">
                        <label for="title" class="text-sm font-semibold italic">
                            Nombre de la ciudad
                            <span class="text-red-500" aria-hidden="true"
                                >*</span
                        ...
                        <input
                            ...
                            class="w-full rounded-lg border border-primary/30 bg-background px-4 py-3 text-base transition-all outline-none focus:border-primary focus:ring-1 focus:ring-primary"
                            :class="{ 'border-red-500': errors.customCity }"
                            :aria-invalid="!!errors.customCity"
                            required
                        />
                        <div class="flex justify-between text-xs opacity-50">
                            <span
